...
public:
  ...
  // 确认回报
  virtual int OnRtnOrderConfirm(CRtnStkOrderConfirmField *p_pRtnOrderConfirmField) {return 0;}

  // 成交回报
  virtual int OnRtnOrderFill(CRtnStkOrderFillField *p_pRtnOrderFillField) {return 0;}
