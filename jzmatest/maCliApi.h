...
//////////////////////////////////////////////////////////////////////////
// 通信类型定义
#define COMM_TYPE_KCXP                      1
#define COMM_TYPE_ZMQ                       2
#define COMM_TYPE_SOCKET                    3
#define COMM_TYPE_SHM                       4
...
//函数原型如:OnRecv(const char *p_pszAcceptSn, const unsigned char *p_pszDataBuff, int p_iDataLen) 
//函数原型如:OnRecv(const char *p_pszMsgId, const unsigned char *p_pszDataBuff, int p_iDataLen) 
