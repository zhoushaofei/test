...
//初始化
ITPDK_API bool SECITPDK_Init(int commsize/*参数不再生效*/);
//退出
...
/*
	...
	return				返回查询到的记录数
*/
ITPDK_API int64 SECITPDK_QueryZQDMInfo(const char* khh, int nRowcount, const char *lpBrowindex, const char* lpJys, const char* lpZqdm, const char* lpZQLB, vector<ITPDK_ZQDM>& arZQDM);
ITPDK_API int64 SECITPDK_QueryZQDMInfoEx(ITPDK_CusReqInfo& cusreqinfo, int nRowcount, const char* lpBrowindex, const char* lpJys, const char* lpZqdm, const char* lpZQLB, vector<ITPDK_ZQDM>& arZQDM);
